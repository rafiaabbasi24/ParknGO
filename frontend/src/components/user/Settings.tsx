...
const Settings = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative mb-8 p-6 rounded-2xl overflow-hidden bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/20 shadow-xl transition-all duration-300"
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-blue-950 dark:text-blue-200">
                Account Settings
              </h1>
      ...
      >
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-800/30 p-4 rounded-xl shadow-sm flex items-start gap-3 transition-transform duration-300 hover:-translate-y-1 hover:shadow-md">
